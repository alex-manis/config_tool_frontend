...
**Support engineers** need to view and edit publisher configurations regularly. They're technical users who can work with simple CSS/JS and understand JSON, but have **limited expertise** — editing raw JSON files directly leads to syntax errors and frustration.
